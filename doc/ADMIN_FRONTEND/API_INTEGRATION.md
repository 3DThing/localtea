...
> ⚠️ **Сетевые требования**: API Admin Backend доступен только через корпоративную VPN-сеть. Убедитесь, что вы подключены к VPN перед тестированием или разработкой.
