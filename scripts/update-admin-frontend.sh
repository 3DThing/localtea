...
# Update admin_frontend in production (Docker Compose v1).
# Usage:
#   ./scripts/update-admin-frontend.sh [--no-cache] [--pull] [--force-recreate] [--hard-recreate]
# Examples:
#   ./scripts/update-admin-frontend.sh
#   ./scripts/update-admin-frontend.sh --pull
#   ./scripts/update-admin-frontend.sh --no-cache --force-recreate
#   ./scripts/update-admin-frontend.sh --hard-recreate
